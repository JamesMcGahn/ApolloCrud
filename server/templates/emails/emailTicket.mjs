const emailTicket = (ticket, comments) => {
  ...
  const txComms = comments.slice().reverse();
  ...
  const ticketComments = tixCommentsHtml.join('');
                            ...
                            <tr>
                              ...
                              >
                                ...
                                >
                                  ...
                                  <p>New comment update for Ticket:</p>
                                </div>
                              </td>
                            </tr>
                          </tbody>
...
<a href="${process.env.FE_DOMAIN}/ticket/${id}"> 
    ...
    <!--[if mso]></div><![endif]-->
    <!--[if IE]></div><![endif]-->
    <div style="display: none;">[Ticket:${id}]</div>
  </body>
</html>
`;
};
